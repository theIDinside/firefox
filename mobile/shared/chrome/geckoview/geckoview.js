...
function startup() {
  ...
  const settings = window.arguments[0].QueryInterface(Ci.nsIGeckoViewView)
    .initData.settings;

  const browsingContextGroupId = settings?.browsingContextGroupId;
  ...
  const remoteType = settings?.remoteType;
