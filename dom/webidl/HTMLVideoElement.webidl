...
partial interface HTMLVideoElement {
  [Pref="dom.picture-in-picture.enabled", NewObject] Promise<PictureInPictureWindow> requestPictureInPicture();

  [Pref="dom.picture-in-picture.enabled"] attribute EventHandler onenterpictureinpicture;
  [Pref="dom.picture-in-picture.enabled"] attribute EventHandler onleavepictureinpicture;

  [Pref="dom.picture-in-picture.enabled", CEReactions, SetterThrows] attribute boolean disablePictureInPicture;
};
